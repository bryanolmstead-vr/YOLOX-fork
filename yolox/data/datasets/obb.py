...
class OBBDataset(CacheDataset):
    """
    OBB dataset class, using COCO-style JSON with angles
    """
    ...
    def load_anno_from_ids(self, id_):
        ...
        res = np.zeros((num_objs, 6)) # 6 columns for [x_center, y_center, width, height, angle, class_id]
    ...
    def __getitem__(self, index):
        ...
        #print(f"BLO __getitem__ index={index}, num_boxes={target.shape[0]}, target={target}")
